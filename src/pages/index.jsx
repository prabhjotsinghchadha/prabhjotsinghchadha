...
function Resume() {
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <Button href="https://drive.google.com/file/d/1t9SuOuasxsLpyt2dliKSuU4u_mBMwF8r/view?usp=sharing" variant="secondary" className="group mt-6 w-full">
        Download CV
...
export default function Home({ articles }) {
  return (
    <>
      <Head>
        <title>
          Prabhjot Singh Chadha - Indie Developer, Freelancer, and Coffee Specialist
        </title>
        <meta
          name="description"
          content="I’m Prabhjot, a Software Engineer and Freelancer based in India. , where we develop technologies that empower regular people to explore space on their own terms."
        />
      </Head>
